...
- **`<23KB` core bundle** vs Shepherd's ~25KB.
...
- **If AGPL is the blocker and you're on React** — pick userTourKit. BSL 1.1 (MIT on its Change Date), React-first, broader scope.
