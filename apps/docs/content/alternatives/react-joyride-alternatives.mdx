...
|------|---------|---------------------|------------------|-----------|
| **userTourKit** | BUSL-1.1 | `<23KB` | Tours + hints + checklists + announcements + analytics | React |
...
- **If you need first-class React and broad onboarding scope in one package** — userTourKit.
