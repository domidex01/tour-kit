...
*Tour Kit is an open-source product tour library for React. The core packages are BUSL-1.1-licensed and source-available. Extended packages require a [Pro license](https://usertourkit.com/). This article reflects the author's own experience choosing a business model — your situation may differ.*
