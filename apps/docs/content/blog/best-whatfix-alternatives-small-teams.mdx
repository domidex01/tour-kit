...
<tbody>
<tr><td>Tour Kit</td><td>Open-core library</td><td>$0 (MIT) / $9.99 one-time</td><td>Unlimited</td><td>$0</td><td>New</td><td>React teams who code</td></tr>
