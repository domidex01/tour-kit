...
**Track your bundle budget.** Tour Kit publishes [bundle size targets](/blog/tour-kit-8kb-zero-dependencies): core under 23KB, react under 12KB, hints under 6.5KB gzipped. Monitor your total onboarding bundle with bundlephobia or your build tool's analysis output.
