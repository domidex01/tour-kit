...
The tour (`@tour-kit/react`) and hints are source-available under BUSL-1.1 (free in development). Checklists, analytics, announcements, adoption, media, and scheduling are Pro — $9.99 one-time for all of them. For production onboarding flows, the Pro packages pay for themselves in the first week.
