...
Tour Kit addresses vendor lock-in by keeping tour definitions in your codebase as React components, routing event data to your own analytics providers, and using BUSL-1.1 licensing on core packages so you can fork, modify, and self-host with the full source visible. If you stop using Tour Kit tomorrow, you still have the code.
