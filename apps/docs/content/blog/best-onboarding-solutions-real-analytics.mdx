...
As of April 2026, Tour Kit's analytics package ships at under 23KB gzipped with zero runtime dependencies. The core library supports React 18 and 19 natively with full TypeScript type exports.
...
- Sub-23KB gzipped footprint for the entire analytics layer, 12-25x smaller than SaaS alternatives
...
Pendo has the deepest analytics with native session replay plus full product usage tracking, but costs around $48,000/year. Userpilot offers comparable depth starting at $249/month. Tour Kit pipes typed events directly to your data warehouse through a plugin architecture at under 23KB gzipped.
