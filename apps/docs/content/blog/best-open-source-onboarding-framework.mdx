...
Tour Kit takes a different approach: the full stack ships as source-available packages, free to build with. Serving them to end users costs $9.99 one-time.
