...
<tr><td>Tour Kit</td><td>core &lt;23KB gzip</td><td>Yes (native)</td><td>WCAG 2.1 AA</td><td>Yes</td><td>BUSL-1.1</td></tr>
</tbody>
</table>
...
Tour Kit's core ships at under 23KB gzipped with zero runtime dependencies. It has real limitations: no visual builder (you need a developer), no mobile SDK, React 18+ only, and a smaller community than React Joyride.
...
Bundle impact varies widely. Driver.js adds approximately 5KB gzipped, the smallest option. Tour Kit's core is under 23KB gzipped. React Joyride ships 498KB unpacked. According to [web.dev](https://web.dev/vitals/), every additional 10KB of JavaScript adds measurable First Input Delay impact on mobile.
...
export const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Bundle impact varies widely. Driver.js adds approximately 5KB gzipped (the smallest option). Tour Kit's core is under 23KB gzipped. React Joyride ships 498KB unpacked."
      }
    },
    {
      "@type": "Question",
