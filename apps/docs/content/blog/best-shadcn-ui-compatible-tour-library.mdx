...
Tour Kit's core packages (@tourkit/core, @tourkit/react, @tourkit/hints) are MIT licensed and free. Extended packages (analytics, surveys, checklists, announcements) require a one-time Pro license at $9.99. No per-seat fees, no MAU pricing. Full breakdown at [usertourkit.com](https://usertourkit.com/).
