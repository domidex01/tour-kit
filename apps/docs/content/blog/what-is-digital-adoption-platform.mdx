...
If you just want guided tours without the enterprise overhead, [Tour Kit](https://usertourkit.com/) gives you headless, composable React components at under 23KB gzipped. But read on to understand the full picture first.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Free/OSS or $9.99 one-time</td>
    </tr>
    <tr>
      <td>Bundle impact</td>
...
[Tour Kit's 10 composable packages](https://usertourkit.com/) cover the same feature surface as a mid-market DAP, but as npm packages you own and control. The core ships at under 23KB gzipped. No visual builder, though, so your team needs React developers. That's the tradeoff.
