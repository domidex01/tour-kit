...
Tour Kit's core at ~23KB gzipped leaves room for whichever i18n library your project already uses. Opinionated tour libraries that ship at 37-45KB force you toward the lightest possible i18n solution, or you accept a 60-70KB combined payload just for onboarding.
...
Tour Kit's core ships at ~23KB gzipped. Combined with next-intl (457B), total payload is ~8.5KB. With react-i18next, it's ~30KB. React Joyride (37KB) plus react-i18next totals ~59KB. Headless tour libraries leave more budget for the i18n library your project needs.
