...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>23KB gzipped core (tree-shakeable)</td>
    </tr>
    <tr>
...
Real concern. 63% of enterprises have experienced open-source license violations in the past two years ([CTO Magazine](https://ctomagazine.com/open-source-software-pros-and-cons/)). The mitigation is choosing permissive or source-available licenses. Tour Kit uses BUSL-1.1, which allows unrestricted development use, modification, and distribution with no copyleft obligations (production needs a licence key). No GPL contamination risk.
