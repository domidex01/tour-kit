...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Tree-shaken: core &lt;23KB, react &lt;12KB gzipped</td>
    </tr>
    <tr>
      <td>Updates</td>
...
For a deeper look at how Tour Kit achieves its small footprint, see [how Tour Kit ships at 23KB gzipped with zero dependencies](/blog/tour-kit-8kb-zero-dependencies). For the broader architectural decisions, see [the architecture of a 10-package composable tour library](/blog/composable-tour-library-architecture).
