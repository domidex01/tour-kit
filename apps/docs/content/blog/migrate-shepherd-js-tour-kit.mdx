...
Tour Kit's entire codebase (all 10 packages) uses the MIT license. No dual licensing, no commercial tiers for the core functionality. [Tour Kit Pro](/pricing) exists at $9.99 one-time for extended packages, but the core tour engine is MIT forever.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>@tourkit/core</code> (MIT)</td>
...
<script type="application/ld+json">{JSON.stringify({
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "Is Tour Kit's MIT license really free for commercial use?",
      "acceptedAnswer": {
        "@type": "Answer",
