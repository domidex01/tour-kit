...
Tour Kit's entire codebase (all 10 packages) uses the MIT license. No dual licensing, no commercial tiers for the core functionality. [Tour Kit Pro](/pricing) exists at $99 one-time for extended packages, but the core tour engine is MIT forever.
