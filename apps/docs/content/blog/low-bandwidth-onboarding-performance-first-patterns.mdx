...
1. **Ship under 50 KB for the tour chunk.** Tour Kit core + react is under 35 KB gzipped combined. That's a 0.7-second download on 3G. React Joyride's unpacked 498 KB takes over 4 seconds.
