...
A code-first library like Tour Kit ships at under 23KB gzipped for the core package. You write tour steps in TypeScript, your tooltips use existing components, and your analytics pipe into whatever system you already run. Everything lives in version control, behind code review, inside your CI pipeline.
...
Tour Kit doesn't include a visual builder. All tour configuration happens in code, keeping the library lightweight (under 23KB gzipped) and tour logic inside version control. Teams that require drag-and-drop editing should consider Appcues or Userpilot instead.
