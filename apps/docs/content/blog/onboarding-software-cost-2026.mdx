...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>$70,784</td>
      <td>$0-$99 (library) + ~$4,000 (1 dev-week)</td>
    </tr>
    <tr>
      <td>Year 1 total</td>
      <td>$8,600</td>
...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "UserGuiding starts at $69 per month. For React teams, open-source libraries like React Joyride (MIT, $0) or Tour Kit (MIT core, $99 one-time Pro) cost a fraction of any SaaS tool."
      }
    }
  ]
})}
