...
**Bias disclosure:** We built Tour Kit, so it's listed first. Every claim is verifiable against npm, GitHub, and bundlephobia. Take our ranking with appropriate skepticism.
...
## 1. Tour Kit: best TypeScript DX for React teams

<img src="/screenshots/user-tour-kit.avif" alt="Screenshot of Tour Kit - Product Tours for React" width="800" style={{borderRadius: '8px'}} />
...
- 25KB gzipped is 3-5x heavier than Driver.js or Tour Kit core.
