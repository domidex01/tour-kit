...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>N/A (OSS)</td>
      <td>Open-source library</td>
      <td>Free in dev, $9.99 to ship</td>
      <td>✅</td>
...
Tour Kit is a headless onboarding library for React that ships logic without prescribing UI. The core package weighs under 23KB gzipped with zero runtime dependencies. It works with React 18 and 19, supports TypeScript strict mode out of the box, and composes with shadcn/ui, Radix, Tailwind, or any design system your team already uses.
...
- One-time $9.99 Pro license, no monthly fees or per-seat pricing
...
Free MIT core with three open-source packages. Pro packages are $9.99 one-time through [Polar.sh](https://polar.sh).
