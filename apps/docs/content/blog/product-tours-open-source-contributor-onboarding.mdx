...
**Tour Kit** provides the interactive layer: step-by-step tours, checklists, and adoption tracking. Runs on your existing docs site with zero external dependencies. The core package is under 23KB gzipped.
