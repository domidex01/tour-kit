...
Over three years, you're writing checks totaling $70K-$100K for a tool that does what a 23KB open-source library and your existing analytics stack handle together. Here's the math nobody shows you before the sales call.
...
Compare that to the source-available alternative:

**Year 1:** $9.99 (Tour Kit licence, one-time) + 20 hours integration at $150/hr = $3,010

**Year 2:** $0 (the licence is one-time) + 5 hours maintenance = $750

**Year 3:** $0 (the licence is one-time) + 5 hours maintenance = $750

**Three-year total: $4,510**

The gap is $80,490 over three years. That's a full-time engineer for six months.
...
For comparison, PostHog offers a generous free tier with far higher limits. Tour Kit's packages are BUSL-1.1 with no MAU caps and no data retention limits, because the data stays in your infrastructure. An unlicensed production deploy does carry a small badge.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>In-app tours</td>
      <td>Pendo guides</td>
      <td>Tour Kit (BSL 1.1, 23KB gzipped)</td>
    </tr>
    <tr>
      <td>NPS/surveys</td>
...
Shepherd.js (AGPL licensed) and Driver.js ($0 MIT) cost nothing for the software itself, and Tour Kit is $9.99 one-time. Among SaaS alternatives, Usetiful starts at $29 per month and Hopscotch at $9.99 per month. Tour Kit pairs with existing analytics tools (PostHog, Mixpanel) to cover most of what Pendo offers at a fraction of the cost.
