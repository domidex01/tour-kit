...
Over three years, you're writing checks totaling $70K-$100K for a tool that does what an 23KB open-source library and your existing analytics stack handle together. Here's the math nobody shows you before the sales call.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>In-app tours</td>
      <td>Pendo guides</td>
      <td>Tour Kit (MIT, 23KB gzipped)</td>
    </tr>
    <tr>
      <td>NPS/surveys</td>
