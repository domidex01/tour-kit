...
Tour Kit is a headless React library that ships tour logic without prescribing UI. The core package weighs under 23KB gzipped with zero runtime dependencies, and it works natively with React 18 and 19. Ten composable packages cover tours, hints, checklists, announcements, surveys, and analytics. Install only what you need.

**Strengths:**
- Core bundle under 23KB gzipped, tree-shakeable across 10 packages
...
**Pricing:** Free (MIT) for core packages. Pro packages (adoption tracking, scheduling, surveys) available for $9.99 one-time.
...
Is bundle size a concern? Tour Kit's core ships at under 23KB gzipped. Shepherd.js ships at 37KB. SaaS platform scripts typically add 80-200KB. According to [web.dev](https://web.dev/vitals/), every 100KB of JavaScript adds measurable latency on mobile connections, directly impacting Core Web Vitals scores.
...
In-app guidance tools help SaaS companies onboard users and drive adoption through contextual messages inside the product. They range from lightweight JavaScript libraries like Tour Kit (under 23KB gzipped) to full platforms like Pendo. As of April 2026, pricing spans $69/month to $405,000/year.
...
Pricing ranges from free to $405,000/year. Open-source libraries (Tour Kit core, React Joyride) are free under MIT. Mid-market platforms run $69/month (UserGuiding) to $300/month (Appcues). Enterprise DAPs like WalkMe cost $60,000-$405,000/year. Tour Kit Pro is a one-time $9.99 payment.

### Can in-app guidance tools hurt website performance?

Yes. SaaS platform scripts typically add 80-200KB to your JavaScript bundle, which impacts Core Web Vitals on mobile. Headless libraries minimize this: Tour Kit's core is under 23KB gzipped, Shepherd.js ships at 37KB. Measure impact on Largest Contentful Paint before deploying to production.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In-app guidance tools are software that helps SaaS companies onboard users, announce features, and drive adoption through contextual messages displayed inside the product. These tools range from lightweight JavaScript libraries like Tour Kit (under 23KB gzipped) to full platforms like Pendo that combine guidance with product analytics."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Pricing ranges from free to $405,000/year. Open-source libraries (Tour Kit core, React Joyride) are free under MIT. Mid-market platforms start at $69/month (UserGuiding) to $300/month (Appcues). Enterprise DAPs like WalkMe run $60,000-$405,000/year. Tour Kit Pro is a one-time $9.99 payment."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. SaaS platform scripts typically add 80-200KB to your JavaScript bundle. Headless libraries minimize this: Tour Kit core is under 23KB gzipped, Shepherd.js ships at 37KB. Measure impact on Largest Contentful Paint and Interaction to Next Paint before deploying."
      }
    }
  ]
})}
