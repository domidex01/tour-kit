...
- Tour Kit core ships at under 23KB gzipped versus React Joyride's approximately 30KB
...
Tour Kit's core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are BUSL-1.1 licensed and source-available. Extended packages like analytics, checklists, and announcements require a [Pro license at $9.99 one-time](/pricing). The free tier covers everything needed for a standard React Joyride migration.
