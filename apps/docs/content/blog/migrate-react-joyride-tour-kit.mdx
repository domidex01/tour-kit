...
Tour Kit's core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are MIT licensed and free. Extended packages like analytics, checklists, and announcements require a [Pro license at $99 one-time](/pricing). The free tier covers everything needed for a standard React Joyride migration.
