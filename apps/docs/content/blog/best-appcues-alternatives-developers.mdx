...
Appcues Essentials starts at $249 per month for up to 2,500 MAUs, which totals $2,988 per year minimum. Tour Kit's core is MIT-licensed and free, with Pro at $9.99 one-time. React Joyride and Driver.js are both MIT and free. Shepherd.js is free under AGPL but requires a commercial license for proprietary apps.
