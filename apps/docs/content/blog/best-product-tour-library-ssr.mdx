...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Driver.js at approximately 5KB gzipped is the lightest, though it requires a dynamic import wrapper. User Tour Kit at under 23KB gzipped is the lightest option with clean SSR support out of the box. React Joyride and Shepherd.js both ship around 37KB gzipped."
      }
    },
    {
      "@type": "Question",
