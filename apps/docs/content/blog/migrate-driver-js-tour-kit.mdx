...
userTourKit addresses all five. It is headless -- you provide the UI components, and it handles step sequencing, element positioning, scroll management, keyboard navigation, and persistence. The core package is under 23KB gzipped.
