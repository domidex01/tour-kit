...
Core packages are MIT and free. Extended packages (adoption, announcements, checklists, media, scheduling) require a Pro license at $9.99 one-time.
...
userTourKit's three core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are BUSL-1.1 licensed and source-available, as is every package. Adoption tracking, analytics, announcements, checklists, media and scheduling are included too, and one $9.99 licence covers serving any of them to end users. No subscriptions, no per-seat pricing, no usage limits.
...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "userTourKit's three core packages (@tourkit/core, @tourkit/react, @tourkit/hints) are BUSL-1.1 licensed and source-available, as is every package. One $9.99 licence covers serving any of them to end users. No subscriptions, no per-seat pricing, no usage limits."
      }
    },
    {
      "@type": "Question",
