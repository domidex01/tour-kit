...
userTourKit's three core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are BUSL-1.1 licensed and source-available. Seven extended packages (adoption tracking, analytics, announcements, checklists, media, scheduling, and the license package) require a one-time $9.99 Pro license. No subscriptions, no per-seat pricing, no usage limits.
...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "userTourKit's three core packages (@tourkit/core, @tourkit/react, @tourkit/hints) are BUSL-1.1 licensed and source-available. Seven extended packages require a one-time $9.99 Pro license. No subscriptions, no per-seat pricing, no usage limits."
      }
    },
    {
      "@type": "Question",
