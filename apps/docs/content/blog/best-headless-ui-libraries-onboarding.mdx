...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "userTourKit's three core packages (@tourkit/core, @tourkit/react, @tourkit/hints) are MIT licensed and free. Seven extended packages require a one-time $9.99 Pro license. No subscriptions, no per-seat pricing, no usage limits."
      }
    },
    {
      "@type": "Question",
