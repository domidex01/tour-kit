...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Headless hook architecture reduces bundle size by shipping logic without UI. Function components with hooks produce minified bundles 59.55% smaller than equivalent class components. Tour Kit's core ships under 23KB gzipped because hooks contain zero JSX, zero CSS, and zero DOM opinions."
      }
    }
  ]
})}
