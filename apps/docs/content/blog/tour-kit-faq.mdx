...
- **Licensing:** Shepherd's core is MIT, but "a paid license is required for commercial use" of advanced features ([Usertour](https://www.usertour.io/blog/product-tour-joyride)). Tour Kit is MIT for core packages, $9.99 one-time for Pro.
...
Tour Kit's core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are MIT-licensed. Free for commercial use, no restrictions. The extended packages (analytics, adoption, checklists, surveys, announcements, media, scheduling) require a Pro license at $9.99 one-time per project.
