...
Tour Kit's core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are MIT-licensed and free for commercial use. Extended packages for analytics, checklists, surveys, and media require a Pro license at $9.99 one-time per project. No per-user or per-MAU pricing.
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Tour Kit's core packages are MIT-licensed and free for commercial use. Extended packages for analytics, checklists, surveys, and media require a Pro license at $9.99 one-time per project."
        }
      },
      {
        "@type": "Question",
