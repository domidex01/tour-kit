...
All of it ships under 23KB gzipped for the core, with no runtime dependencies. You render your own components. Tour Kit handles the logic: when to show, when to dismiss, what the user has already seen.
