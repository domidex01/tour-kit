...
Tour Kit's core is under 23KB gzipped with zero runtime dependencies. It doesn't touch React internals. When React 20 lands, your tours won't break.
...
For React 19, the top alternatives are React Joyride (706K weekly downloads, MIT), Tour Kit (headless-first, under 23KB gzipped, MIT, WCAG 2.1 AA), and Driver.js (lightweight, MIT). All three are React-native and didn't need patches for React 19.
