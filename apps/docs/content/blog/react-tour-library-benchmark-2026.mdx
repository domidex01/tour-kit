...
- Extended packages (adoption, surveys, scheduling) require a Pro license at $9.99 one-time

### Pricing

MIT open source for core packages. Pro extended packages: $9.99 one-time.
