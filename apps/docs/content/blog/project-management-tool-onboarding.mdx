...
Tour Kit ships at under 23KB gzipped with zero dependencies. For comparison, React Joyride is ~37KB and Shepherd.js ~30KB ([Bundlephobia](https://bundlephobia.com/), April 2026). In a PM tool where the main bundle already includes a rich text editor, drag-and-drop library, and charting library, keeping the tour layer small matters.
