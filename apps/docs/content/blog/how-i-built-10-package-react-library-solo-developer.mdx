...
**Bundle budgets caught regressions early.** Hard limits: core under 23KB gzipped, react under 12KB, hints under 6.5KB. Turborepo runs `size` as a build task. Every time I added a dependency or utility, the budget told me immediately whether it was worth the bytes.
...
| Core bundle size | Under 23KB gzipped |
