...
This is the approach User Tour Kit takes. The core logic lives in `@tourkit/core` at under 23KB gzipped. The React bindings in `@tourkit/react` give you hooks like `useTour()` and `useStep()` that return state and callbacks, and you render them however you want.
...
<tbody>
<tr><td>User Tour Kit</td><td>Headless, composable</td><td>Under 23KB core</td><td>Strict mode</td><td>Yes</td><td>Design system teams</td></tr>
