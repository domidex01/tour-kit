...
DOMPurify adds roughly 6.4KB gzipped to your bundle ([npm: dompurify](https://www.npmjs.com/package/dompurify)). Tour Kit's core is under 23KB gzipped, so you're looking at ~30KB total, still smaller than React Joyride alone.
