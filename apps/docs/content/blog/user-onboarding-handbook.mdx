...
Headless libraries provide tour logic (step sequencing, element targeting, scroll management, keyboard navigation) without prescribing UI. You render steps with your own components. User Tour Kit follows this approach: the core ships under 23KB gzipped with zero runtime dependencies, and you compose it with whatever design system you're running.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Free (MIT) / $9.99 one-time Pro</td>
    </tr>
  </tbody>
</table>
...
- **User Tour Kit**: Headless, composable, TypeScript-first. Core under 23KB gzipped. 17 packages (tours, checklists, hints, announcements, surveys, analytics, scheduling, media, adoption). BUSL-1.1 source-available tier, $9.99 one-time Pro. React 18 and 19. WCAG 2.1 AA. No visual builder (the honest trade-off).
...
*User Tour Kit is BUSL-1.1 licensed. Free in development for core features. Pro packages available for a $9.99 one-time payment. [Browse the documentation](https://usertourkit.com/) or [view the source on GitHub](https://usertourkit.com/).*
