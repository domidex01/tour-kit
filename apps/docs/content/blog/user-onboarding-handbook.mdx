...
- **User Tour Kit**: Headless, composable, TypeScript-first. Core under 23KB gzipped. 10 packages (tours, checklists, hints, announcements, surveys, analytics, scheduling, media, adoption). MIT free tier, $9.99 one-time Pro. React 18 and 19. WCAG 2.1 AA. No visual builder (the honest trade-off).
