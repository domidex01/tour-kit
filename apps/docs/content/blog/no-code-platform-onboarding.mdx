...
Tour Kit's core sits under 23KB gzipped and ships with zero runtime dependencies. For no-code platforms where performance is already a concern (visual editors are heavy), that matters. But to be fair: if your platform isn't React-based, the SaaS tools or Shepherd.js might be a more practical choice.
