...
Tour Kit is a headless, composable product tour library for React that ships at under 23KB gzipped for the core package. Instead of giving you pre-built tooltip UI, it gives you hooks and primitives. You render steps with your own components, which means tours match your design system by default rather than fighting a theme editor.

We built Tour Kit. So yes, we're biased. Every number here links to a public source so you can verify independently.

### Strengths

- Core bundle under 23KB gzipped with zero runtime dependencies
...
Free and open source (MIT) for the core packages. Pro license at $9.99 one-time for extended packages (adoption tracking, scheduling, surveys).
...
One angle no competitor article mentions: bundle size. Intercom loads its entire Messenger SDK even if you only use tours. Tour Kit's core ships at under 23KB gzipped. For teams where Core Web Vitals matter, the JavaScript weight of your tour tool is worth measuring. Google's research on web.dev shows that every 100KB of JavaScript costs roughly 350ms on a median mobile device ([web.dev, 2025](https://web.dev/vitals/)).
...
Tour Kit is the best Intercom product tour alternative for React teams in 2026. Ships under 23KB gzipped with WCAG 2.1 AA accessibility. Costs $0 for the open-source core or $9.99 one-time for Pro. No recurring fees versus Intercom's $273/month minimum.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit is the best Intercom product tour alternative for React teams in 2026. Ships under 23KB gzipped with WCAG 2.1 AA accessibility. Costs $0 for the open-source core or $9.99 one-time for Pro. No recurring fees versus Intercom's $273/month minimum."
      }
    },
    {
      "@type": "Question",
