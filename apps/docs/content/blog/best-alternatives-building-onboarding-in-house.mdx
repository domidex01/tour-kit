...
Tour Kit, React Joyride, Shepherd.js, Driver.js, and Onborda are all MIT-licensed and free. Tour Kit provides a headless architecture under 23KB gzipped with WCAG 2.1 AA compliance. React Joyride has the largest community at 340K+ weekly downloads. Your choice depends on framework and design system requirements.
