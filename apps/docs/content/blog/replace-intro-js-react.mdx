...
We'll replace an Intro.js tour with Tour Kit, a headless React library that ships under 23KB gzipped (core) and uses MIT licensing. Every code example below compiles against `@tourkit/core` 0.x and `@tourkit/react` 0.x.
