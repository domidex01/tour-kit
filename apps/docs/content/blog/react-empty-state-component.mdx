...
```json
{
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit handles multi-step sequencing, element highlighting with scroll management, keyboard navigation between tour steps, and completion tracking. Building these from scratch typically takes 2-3 weeks. Tour Kit's core ships at under 23KB gzipped."
      }
    }
  ]
}
