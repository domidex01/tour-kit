...
**Tour Kit.** 10 composable packages covering tours, checklists, announcements, hints, surveys, analytics, media, adoption tracking, and scheduling. Core under 23KB gzipped, zero runtime dependencies, React 18 and 19 native support. MIT free tier, $9.99 one-time Pro. We built this, so take that context into account. ([usertourkit.com](https://usertourkit.com/))
...
Tour Kit's headless core ships at under 23KB gzipped with zero runtime dependencies. React Joyride ships at 37KB gzipped (4.6x larger). Shepherd.js is 25KB. The difference matters for Core Web Vitals: Google's data shows pages loading over 45KB of JS see 23% higher bounce rates on mobile.
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit's headless core ships at under 23KB gzipped with zero runtime dependencies. React Joyride ships at 37KB gzipped (4.6x larger). Shepherd.js is 25KB. The difference matters for Core Web Vitals: Google's data shows pages loading over 45KB of JS see 23% higher bounce rates on mobile."
      }
    },
    {
      "@type": "Question",
