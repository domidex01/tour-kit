...
Styled onboarding tools didn't keep up. React Joyride ships at 37KB gzipped. Shepherd.js adds 25KB. Intro.js lands at 12KB but brings its own CSS that fights your design tokens. A headless approach like Tour Kit's core package targets under 23KB gzipped with zero runtime dependencies.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>$0 (MIT) or $9.99 one-time (Pro)</td>
      <td>$0 (open source)</td>
...
**Tour Kit.** 17 composable packages covering tours, checklists, announcements, hints, surveys, analytics, media, adoption tracking, and scheduling. Core under 23KB gzipped, zero runtime dependencies, React 18 and 19 native support. BUSL-1.1 source-available tier, $9.99 one-time Pro. We built this, so take that context into account. ([usertourkit.com](https://usertourkit.com/))
...
Tour Kit's headless core ships at under 23KB gzipped with zero runtime dependencies. React Joyride ships at 37KB gzipped (1.6x larger). Shepherd.js is 25KB. The difference matters for Core Web Vitals: Google's data shows pages loading over 45KB of JS see 23% higher bounce rates on mobile.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Headless onboarding is a pattern where the tour library provides logic (step sequencing, element targeting, persistence, analytics) without rendering any UI. You supply all visual components using your own design system. Tour Kit is the most complete headless onboarding library for React, with core under 23KB gzipped and 10 composable packages."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit's headless core ships at under 23KB gzipped with zero runtime dependencies. React Joyride ships at 37KB gzipped (1.6x larger). Shepherd.js is 25KB. The difference matters for Core Web Vitals: Google's data shows pages loading over 45KB of JS see 23% higher bounce rates on mobile."
      }
    },
    {
      "@type": "Question",
