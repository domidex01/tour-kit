...
**Tour Kit.** 10 composable packages covering tours, checklists, announcements, hints, surveys, analytics, media, adoption tracking, and scheduling. Core under 8KB gzipped, zero runtime dependencies, React 18 and 19 native support. MIT free tier, $9.99 one-time Pro. We built this, so take that context into account. ([usertourkit.com](https://usertourkit.com/))
