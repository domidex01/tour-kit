...
Tour Kit is a headless digital adoption toolkit for React. Instead of injecting a third-party script, you install npm packages and render onboarding UI with your own components. The core ships at under 23 KB gzipped with zero runtime dependencies. Ten composable packages cover tours, checklists, surveys, announcements, analytics, and adoption tracking.
...
- Core bundle under 23 KB gzipped. Install only the packages you need; tours, checklists, surveys, and analytics are separate imports.
...
- One-time $9.99 Pro license for extended packages. No per-MAU pricing.
...
Free MIT core packages. $9.99 one-time for Pro packages (adoption, checklists, surveys, announcements, media, scheduling).
...
Hopscotch stands out because you can see every plan and price on their website without talking to sales. Starting at $9.99 per month for 3,000 MAU, it covers product tours, checklists, banners, and hints. No hidden tiers, no "contact us for pricing" on the features your startup actually needs.
...
- 3,000 MAU at the $9.99 tier is generous for early-stage products.
...
Startup-tier DAP pricing ranges from $55 to $249 per month as of April 2026. HelpHero starts at $55/month, UserGuiding at $89/month, Hopscotch at $99/month. Tour Kit charges a one-time $9.99 fee for Pro packages with no monthly costs. Enterprise tools like WalkMe and Pendo's paid plans start above $7,000 per year.
...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Two genuinely free options exist. Pendo Free gives you analytics, in-app guides, and NPS surveys for up to 500 monthly active users with Pendo branding. Tour Kit's core packages are BUSL-1.1 source-available (free in development) with no MAU limits."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Startup-tier DAP pricing ranges from $55 to $249 per month as of April 2026. HelpHero starts at $55/month, UserGuiding at $89/month, and Hopscotch at $99/month. Tour Kit charges a one-time $9.99 fee for Pro packages with no monthly costs."
      }
    },
    {
      "@type": "Question",
