...
<script type="application/ld+json">{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Analytics.js 2.0 loads about 16KB gzipped initially, with destination SDKs loaded on demand. Combined with Tour Kit's core at under 23KB gzipped, total overhead is roughly 24KB. Events fire asynchronously and don't block tour transitions."
      }
    },
    {
      "@type": "Question",
