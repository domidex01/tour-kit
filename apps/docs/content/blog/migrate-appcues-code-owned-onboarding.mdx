...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>@tourkit/core</code> at 23KB gzipped</td>
...
Tour Kit's core package is under 23KB gzipped with zero runtime dependencies. Adding it alongside Appcues won't meaningfully change your bundle size during the transition period.
...
**What you gain:**
- Zero per-user cost. Tour Kit core is MIT-licensed. Pro packages cost $9.99 one-time, not a monthly fee that scales with MAUs.
...
- Bundle size under 23KB gzipped for core. Ship only what you use.
...
Tour Kit core is free (MIT). Pro features cost $9.99 one-time. Appcues Growth runs $879/month at 2,500 MAUs on annual billing ([TrustRadius, April 2026](https://www.trustradius.com/products/appcues/pricing)). Switching saves roughly $10,000-$14,000 per year depending on MAU volume, minus developer hours for migration.
