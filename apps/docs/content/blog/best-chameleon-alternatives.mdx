...
Tour Kit is a headless, composable product tour library built specifically for React 18 and 19. With a core bundle under 23KB gzipped, it ships tour logic without prescribing UI, so you render steps with your own components. As of April 2026, it's the only product tour tool we've found that documents and tests WCAG 2.1 AA compliance, including focus management, keyboard navigation, ARIA live regions, and skip-to-content buttons.
...
Free forever (MIT open source). Pro features available for $9.99 one-time purchase.
...
- 37KB gzipped, which is 1.6x larger than Tour Kit's core
...
Tour Kit is the best Chameleon alternative for React developers who want code ownership and accessibility. Ships under 23KB gzipped with WCAG 2.1 AA support at $0 in dev (BUSL-1.1) or $9.99 one-time for Pro. For no-code teams, Appcues at $249/month offers the fastest setup.

### Is there a cheaper alternative to Chameleon?

UserGuiding starts at $69/month for 1,000 MAU, making it the cheapest SaaS option. Tour Kit's open-source core is free with a $9.99 one-time Pro upgrade. Both are significantly cheaper than Chameleon's $279/month Startup plan, which averages over $30,000/year at scale according to Vendr marketplace data.
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit is the best Chameleon alternative for React developers who want code ownership and accessibility. Ships under 23KB gzipped with WCAG 2.1 AA support at $0 in dev (BUSL-1.1) or $9.99 one-time for Pro. For no-code teams, Appcues at $249/month offers the fastest setup."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "UserGuiding starts at $69/month for 1,000 MAU, making it the cheapest SaaS option. Tour Kit's open-source core is free with a $9.99 one-time Pro upgrade. Both are significantly cheaper than Chameleon's $279/month Startup plan, which averages over $30,000/year at scale according to Vendr marketplace data."
      }
    },
    {
      "@type": "Question",
