...
This is where Tour Kit's headless architecture pays off. You control the logic; Tour Kit handles positioning, scroll management, and keyboard navigation. The entire `@tourkit/core` package is under 23KB gzipped with zero runtime dependencies, so it won't bloat your dashboard bundle.
