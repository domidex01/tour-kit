...
Here's the stack we'd recommend for a YC startup shipping its first onboarding flow. Total cost: $9.99 or $0 depending on whether you need Pro features. Total setup time: one afternoon.
...
Tour Kit's core is under 23KB gzipped with zero runtime dependencies. No external scripts, no phone-home calls, no third-party domains in your CSP headers.
