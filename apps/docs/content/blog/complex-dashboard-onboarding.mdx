...
**Tour Kit** is a headless React library purpose-built for this. Ten composable packages, ships under 12KB gzipped, works with any design system. The headless architecture means your tour tooltips match your dashboard's existing components exactly, no style overrides needed. Free while you build, $9.99 one-time to ship. [Get started at usertourkit.com](https://usertourkit.com/).
