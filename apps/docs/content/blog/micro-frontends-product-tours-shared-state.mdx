...
<tr><td>Bundle cost</td><td>~0.5KB</td><td>~3KB (Zustand)</td><td>~23KB per module (Tour Kit core)</td></tr>
...
**Tour Kit** provides headless hooks that can run independently in each micro-frontend, with the coordination patterns described in this article. Core ships at under 23KB gzipped. No visual builder, React 18+ only. We built Tour Kit, so take this with appropriate skepticism.
