...
<tr><td>Bundle size (Tour Kit)</td><td>&lt;6.5KB gzipped (@tourkit/hints)</td><td>&lt;12KB gzipped (@tourkit/react)</td></tr>
...
*Get started with Tour Kit: [documentation](https://usertourkit.com/) | [GitHub](https://github.com/domidex01/tour-kit) | `npm install @tourkit/core @tourkit/react @tourkit/hints`*
