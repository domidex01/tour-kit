...
This keeps Amplitude out of your critical path. Tour Kit's core is under 23KB gzipped, so the analytics SDK is the heavier dependency by a factor of 4.5x.
