...
Open-source options (Tour Kit, Shepherd.js, Driver.js) are MIT licensed and free. Tour Kit Pro is a one-time $9.99 payment. SaaS platforms start at $249-$300 per month, scaling with MAUs. For 5,000 MAUs, Appcues costs roughly $500-$800 per month.
