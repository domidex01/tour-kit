...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "React Joyride provides basic keyboard navigation but doesn't implement focus trapping within tooltips or aria-live step announcements. Tour Kit's core ships at under 23KB gzipped and includes useKeyboardNavigation, useFocusTrap, and announce() as first-class APIs."
      }
    },
    {
      "@type": "Question",
