...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit works with both React 18.2+ and React 19. The library uses hooks (useTour, useStep) compatible with React's concurrent features. The core package ships at under 8KB gzipped with zero peer dependencies beyond React itself."
      }
    },
    {
      "@type": "Question",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit's core adds under 8KB gzipped to your bundle, compared to MUI Stepper which pulls in roughly 80KB+. Under 8KB for step management, focus handling, and ARIA support is a reasonable trade-off for most applications."
      }
    },
    {
      "@type": "Question",
