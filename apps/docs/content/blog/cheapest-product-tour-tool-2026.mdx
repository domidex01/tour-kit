...
Get started with Tour Kit at [usertourkit.com](https://usertourkit.com/). The core packages are MIT-licensed and free forever. The Pro upgrade is $9.99 once.
...
Yes. Tour Kit's core packages (`@tourkit/core`, `@tourkit/react`, `@tourkit/hints`) are MIT-licensed and free forever with tour logic, React components, and hint support. The $9.99 Pro license adds analytics, scheduling, surveys, announcements, checklists, and media embedding.
...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Tour Kit's core packages (@tourkit/core, @tourkit/react, @tourkit/hints) are MIT-licensed and free forever. You get tour logic, React components, and hint/beacon support at no cost. The $9.99 Pro license adds analytics, scheduling, surveys, announcements, checklists, adoption tracking, and media embedding."
      }
    }
  ]
})}
