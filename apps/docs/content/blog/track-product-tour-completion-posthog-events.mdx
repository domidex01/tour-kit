...
For context, Tour Kit's core is under 23KB gzipped. The PostHog SDK is the heavier dependency here, but it replaces your entire analytics stack, not just tour tracking.
