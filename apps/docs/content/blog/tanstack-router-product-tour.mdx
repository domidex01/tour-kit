...
Tour Kit's core ships at under 23KB gzipped with zero runtime dependencies. The router adapter adds ~40 lines that tree-shake if unused. Combined with TanStack Router's ~12KB, total routing and tour overhead stays under 40KB gzipped. React Joyride alone ships at 37KB.
