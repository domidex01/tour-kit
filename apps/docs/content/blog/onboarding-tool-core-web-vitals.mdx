...
Tour Kit's core ships at under 23KB gzipped. You can verify this yourself on [bundlephobia](https://bundlephobia.com/) or by running `npx size-limit` in the repo. That transparency is the architectural difference — you can audit the cost before you ship it.
