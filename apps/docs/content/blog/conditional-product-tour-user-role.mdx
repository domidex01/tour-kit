...
<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit's core bundle is under 8KB gzipped. The when callbacks are plain synchronous functions with no DOM queries or network calls. Initialization takes under 2ms in a Vite + React 19 project with 20 conditional steps."
      }
    },
    {
      "@type": "Question",
