...
{JSON.stringify({
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tour Kit renders overlay elements via React portals, placing them outside the main document flow. This means the tour tooltip and backdrop don't push existing page content around when they appear. Tour Kit's core ships at under 8KB gzipped with zero runtime dependencies."
      }
    },
    {
      "@type": "Question",
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Both @vercel/analytics and @vercel/speed-insights load as small async scripts. They don't block rendering or contribute to your main JS bundle in a meaningful way. Combined with Tour Kit's core (under 8KB gzipped), the total footprint stays well under 20KB."
      }
    },
    {
      "@type": "Question",
