...
A mid-market Pendo contract runs $40K-$80K per year with 5-20% annual renewal increases. Tour Kit's core packages are MIT-licensed and free. [Pro features](/pricing) (adoption tracking, scheduling, surveys) are a one-time $9.99 purchase. Even accounting for 40 hours of developer time at $150/hour ($6,000), the migration pays for itself within the first quarter.
...
export const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A mid-market Pendo contract runs $40K-$80K per year. Tour Kit's core packages are MIT-licensed and free. Pro features are a one-time $9.99 purchase. Even accounting for developer time, the migration pays for itself within the first quarter."
      }
    },
    {
      "@type": "Question",
