...
- **54KB third-party script** on every page, loaded before your app code, fetching guide configs from Pendo's servers on each session. Tour Kit's core is under 23KB gzipped and tree-shakes to only what you import
...
<tbody>
<tr><td>Annual cost (mid-market)</td><td>$40K-$80K</td><td>$0 (MIT) or $9.99 one-time Pro</td></tr>
<tr><td>Bundle impact</td><td>54KB third-party script</td><td>&lt;23KB core gzipped, tree-shakeable</td></tr>
...
A mid-market Pendo contract runs $40K-$80K per year with 5-20% annual renewal increases. Tour Kit's core packages are BUSL-1.1-licensed and source-available. [Pro features](/pricing) (adoption tracking, scheduling, surveys) are a one-time $9.99 purchase. Even accounting for 40 hours of developer time at $150/hour ($6,000), the migration pays for itself within the first quarter.
...
export const faqJsonLd = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A mid-market Pendo contract runs $40K-$80K per year. Tour Kit's core packages are BUSL-1.1-licensed and source-available. Pro features are a one-time $9.99 purchase. Even accounting for developer time, the migration pays for itself within the first quarter."
      }
    },
    {
      "@type": "Question",
