...
Both packages are ESM-first with CommonJS fallbacks and ship full TypeScript declarations. Tour Kit's core bundle weighs under 23KB gzipped, so it won't bloat your island.
