...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>Pricing</td>
      <td>$9.99–$199/month add-on</td>
      <td>Free core (MIT), $9.99 one-time Pro</td>
    </tr>
  </tbody>
</table>
...
The Proactive Support Plus add-on costs $9.99 per month for 500 tour sends, with overages beyond that (a 3,000-user run adds roughly $145). Tour Kit's core is BUSL-1.1-licensed and source-available. The Pro package is a one-time $9.99 purchase. For 5,000 monthly tour views: $200+ per month with Intercom versus $0 ongoing with Tour Kit.
