...
The Proactive Support Plus add-on costs $9.99 per month for 500 tour sends, with overages beyond that (a 3,000-user run adds roughly $145). Tour Kit's core is MIT-licensed and free. The Pro package is a one-time $9.99 purchase. For 5,000 monthly tour views: $200+ per month with Intercom versus $0 ongoing with Tour Kit.
