...
**Bundle size stays under control.** React Joyride ships at ~37KB gzipped. Tour Kit's core is ~23KB. When the tour library doesn't include a rendering layer, styles, or animation system, there's less code to ship. For a feature that most users encounter once, during their first session, that 29KB difference matters.
