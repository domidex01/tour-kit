...
<table>
<thead>
<tr><th>React 19 feature</th><th>What it changes for tours</th><th>Tour Kit support</th></tr>
</thead>
<tbody>
...
Check the [Tour Kit docs](https://tourkit.dev/docs) for the full API reference, or clone the [GitHub repo](https://github.com/user-tour-kit/tour-kit) to run the examples locally.
...
```json
{
  ...
  "image": "https://tourkit.dev/og-images/add-product-tour-react-19.png",
  "url": "https://tourkit.dev/blog/add-product-tour-react-19",
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://tourkit.dev/blog/add-product-tour-react-19"
  },
...
- Link TO this article FROM: `/blog/best-product-tour-tools-react` (add as "tutorial" link under Tour Kit entry), `/blog/best-free-product-tour-libraries-open-source`

**Distribution checklist:**
- Cross-post to Dev.to with canonical URL to `tourkit.dev/blog/add-product-tour-react-19`
