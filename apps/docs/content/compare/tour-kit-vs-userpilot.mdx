...
userTourKit's `@tour-kit/checklists` (Pro, $99 one-time) takes a different tack. Tasks support dependency graphs with circular dependency detection and three completion types: manual, event-based, or custom check function. Progress calculation accounts for locked tasks.
...
userTourKit's core packages (`@tour-kit/core`, `@tour-kit/react`, `@tour-kit/hints`) are MIT-licensed and free. Pro packages cost $99 one-time — that covers adoption, analytics, announcements, checklists, media, and scheduling. No MAU limits. No seat limits. Self-hosted by default.
...
Over three years, the math works out to: userTourKit Pro costs $99 total. Userpilot Starter costs $10,764. Userpilot Growth costs $28,764. That's not a rounding error.
...
The cost difference is hard to ignore for startups and growing teams. userTourKit Pro at $99 one-time versus Userpilot Growth at $9,588/year means your onboarding budget pays for itself on day one. No MAU caps mean you don't get penalized as your user base grows.
...
**Is userTourKit free?**
userTourKit's core packages (tours, hints, React components) are MIT-licensed and free. Pro packages covering analytics, checklists, announcements, scheduling, media, and adoption tracking cost $99 one-time. No monthly fees and no MAU limits.
...
No. Userpilot is a proprietary SaaS platform. userTourKit's core packages are MIT-licensed open source. Pro packages require a $99 one-time license.
