...
**Is userTourKit free?**
userTourKit's core packages (tours, hints, headless architecture) are BUSL-1.1-licensed and source-available. The Pro upgrade adds checklists, announcements, analytics, scheduling, plus media and adoption tracking for a $9.99 one-time payment. No monthly fees. No MTU limits.
