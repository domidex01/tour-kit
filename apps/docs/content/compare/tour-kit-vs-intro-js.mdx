...
userTourKit is BSL 1.1. No AGPL. No copyleft. Every package is free while you build, and $9.99 as a one-time purchase to ship. No monthly fees, no MAU limits.
