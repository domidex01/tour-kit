...
| License | MIT (free) + $9.99 Pro | AGPL-3.0 + $9.99–$299.99 commercial |
...
userTourKit's three core packages (core, react, hints) are MIT-licensed and free. The seven Pro packages cost $9.99 as a one-time purchase covering analytics, checklists, announcements, adoption tracking, media, and scheduling. No subscriptions. No MAU limits.
