...
userTourKit's free tier (core, React bindings, hints) is MIT licensed. No legal review needed. The Pro tier costs $9.99 one-time for all seven additional packages. Not recurring.
