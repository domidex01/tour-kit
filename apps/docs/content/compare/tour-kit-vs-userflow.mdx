...
userTourKit's core packages (`@tour-kit/core`, `@tour-kit/react`, `@tour-kit/hints`) are MIT-licensed and free. Pro packages cost $99 one-time. No MAU limits. No per-seat charges. No recurring fees.

Three-year TCO at 10,000 MAUs: Userflow Pro runs $24,480. userTourKit runs $99. The math isn't close.
