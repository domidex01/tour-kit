...
Driver.js ships at roughly 5KB gzipped with zero dependencies. userTourKit's core is under 8KB gzipped, the React package under 12KB, hints under 5KB. userTourKit packages are peer dependencies, so you only bundle what you import.
