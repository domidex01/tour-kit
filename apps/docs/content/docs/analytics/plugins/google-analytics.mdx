...
<Callout type="warn">
  This plugin requires gtag.js to be loaded on the page before the userTourKit analytics provider initializes. Add the Google Analytics script tag to your HTML.
</Callout>
