...
description: >-
  Use Claude Code, ChatGPT, Cursor, and other LLM coding assistants to build with
  userTourKit faster — Claude Code plugin, llms.txt, per-package context files, and MCP.
icon: Bot
---
...
<Callout type="info">
  **Looking for the in-app AI chat runtime instead?** This page is about LLM
  coding tools that help you *build* userTourKit integrations faster (Claude
  Code, Cursor, ChatGPT). If you want to ship an AI chat widget *to your end
  users* that is aware of the active tour, see [`@tour-kit/ai`](/docs/ai).
</Callout>
