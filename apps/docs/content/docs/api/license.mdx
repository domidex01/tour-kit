...
<Callout type="info">
For installation and environment setup see [Licensing](/docs/licensing). Free packages (`@tour-kit/core`, `@tour-kit/react`, `@tour-kit/hints`, `@tour-kit/media`) never need this package.
</Callout>
