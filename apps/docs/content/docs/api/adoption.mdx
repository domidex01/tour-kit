...
description: >-
  API reference for @tour-kit/adoption: AdoptionProvider, useFeature, useNudge,
  useAdoptionStats, and dashboard exports
keywords:
  - tour kit api adoption
...
<IfNotAdopted featureId="feature-search">
  <NewFeatureBadge featureId="feature-search" text="New!" />
</IfNotAdopted>
...
<NewFeatureBadge featureId="feature-id" text="New" variant="default" size="sm" />
```
