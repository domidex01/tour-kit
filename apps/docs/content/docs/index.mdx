...
userTourKit is a source-available headless React library for building product tours, onboarding
checklists, hints, announcements, and in-app messaging. It ships three packages — a framework-agnostic
core under 23KB gzipped, a React component layer under 12KB, and a hints/hotspot layer under 6.5KB —
all under BUSL-1.1 (free in development, licence key in production). WCAG 2.1 AA accessibility, TypeScript-strict types, and Lighthouse 100
