...
description: >-
  ...
  step-level configuration in userTourKit tours
---
...
userTourKit supports dynamic branching, allowing tours to adapt based on user choices. These props control how navigation flows between steps.
