...
title: CSS Variables
description: >-
  Customize userTourKit appearance with CSS custom properties for colors, spacing,
  border radius, and shadow values
---

# CSS Variables

userTourKit exposes CSS variables for easy theming without modifying component code.
