...
description: >-
  Router adapters enable multi-page product tours that persist across route
  changes in React framework applications
---
...
Router adapters connect User Tour Kit to your application's routing system, enabling multi-page tours that navigate users across different routes.
