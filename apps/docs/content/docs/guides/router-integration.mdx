...
Tour Kit supports multi-page tours that navigate users across different routes. This guide covers integration with popular routers.
...
When a step requires a different route, Tour Kit automatically navigates:
