...
description: >-
  Set up Tour Kit with Next.js App Router or Pages Router — server component
...
Complete guide for setting up Tour Kit with Next.js. Covers both App Router (Next.js 13+) and Pages Router.
...
Tour Kit uses client-side features. Add `'use client'` to components that use tours:
