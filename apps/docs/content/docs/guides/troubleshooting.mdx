...
description: >-
  Diagnose and fix common Tour Kit issues: missing targets, positioning
...
Solutions to common issues when using Tour Kit.
...
### Can I use Tour Kit with React Native?

No, Tour Kit is designed for web only. It uses DOM APIs extensively.
...
Yes! Tour Kit is WCAG 2.1 AA compliant with:
...
No, Tour Kit cannot target elements inside iframes due to browser security restrictions.
