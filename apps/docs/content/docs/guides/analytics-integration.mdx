...
Track user interactions across all userTourKit features with the analytics plugin system.
...
userTourKit's analytics system is plugin-based, allowing you to send events to multiple services simultaneously.
