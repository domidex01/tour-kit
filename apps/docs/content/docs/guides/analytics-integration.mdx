...
Track user interactions across all Tour Kit features with the analytics plugin system.
...
Tour Kit's analytics system is plugin-based, allowing you to send events to multiple services simultaneously.
