...
description: >-
  Configure userTourKit in Vite + React projects with hot module replacement, path
  aliases, and production build optimization
howto: true
---
...
Complete guide for setting up userTourKit with Vite and React. Covers single-page apps and React Router integration.
...
userTourKit uses Tailwind CSS classes. Make sure Tailwind is configured:
...
export default {
  content: [
    './index.html',
    './src/**/*.{js,ts,jsx,tsx}',
    './node_modules/@tour-kit/**/*.{js,ts,jsx,tsx}', // Include userTourKit
  ],
  theme: {
    extend: {},
  },
...
Add userTourKit to your Tailwind content paths or import the CSS directly.
</Callout>
