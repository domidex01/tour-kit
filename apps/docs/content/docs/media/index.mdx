...
title: Media
description: >-
  Embed YouTube, Vimeo, Loom, Wistia, GIF, and Lottie media in tours with
  automatic platform detection and accessibility
---
...
<Callout type="info" title="LLM Context File">
  ...
  <a href="/context/media.txt" download>context file for @tour-kit/media</a>
