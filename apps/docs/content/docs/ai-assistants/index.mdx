...
```
Read https://tour-kit-docs.vercel.app/llms-full.txt and use it as context for userTourKit questions
```
...
```
Fetch https://tour-kit-docs.vercel.app/llms.txt to understand the userTourKit API
```
