...
description: >-
  Track feature usage, measure adoption rates, and nudge users toward underused
  features with @tour-kit/adoption for React
---
...
<Callout type="info" title="LLM Context File">
  ...
  <a href="/context/adoption.txt" download>context file for @tour-kit/adoption</a>
  ...
  return (
    <button id="dark-mode-toggle" className="relative">
      ...
      <IfNotAdopted featureId="dark-mode">
        <NewFeatureBadge featureId="dark-mode" text="New!" />
      </IfNotAdopted>
    </button>
  )
}
