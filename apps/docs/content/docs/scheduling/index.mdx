...
description: >-
  Time-based scheduling for controlling when tours, announcements, and content
  appear — business hours, dates, and timezones
---
...
<Callout type="info" title="LLM Context File">
  ...
  <a href="/context/scheduling.txt" download>context file for @tour-kit/scheduling</a>
