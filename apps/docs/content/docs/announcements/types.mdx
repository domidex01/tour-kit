...
Raw React context. Prefer [`useAnnouncementsContext`](/docs/announcements/hooks/use-announcements-context) — it throws when used outside `<AnnouncementsProvider>`.
