...
Check out the [Tour Kit docs](https://usertourkit.com/docs) for step configuration and analytics integration. The full example code from this tutorial is available on [GitHub](https://github.com/domidex01/tour-kit/tree/main/examples).
