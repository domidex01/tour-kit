...
This is a tutorial covering how to build a 4-step product tour in a React 19 app using userTourKit, a headless tour library I built (under 8KB gzipped core).
...
Sentry's engineering team wrote about this exact problem when building their product tours — step text separated from the focused element made conditional logic painful. userTourKit co-locates step content with step config to avoid that.
...
Full disclosure: I built userTourKit. The tutorial should be useful for anyone implementing tours in React 19 regardless of the library they choose.
