...
published: false
description: "The AGPL license shows up in ~4,200 npm packages. One in your dependency tree is enough to trigger source code disclosure. Here's what AGPL actually requires and why it matters for React developers."
tags: javascript, opensource, webdev, react
canonical_url: https://usertourkit.com/blog/what-is-agpl-license
cover_image: https://usertourkit.com/og-images/what-is-agpl-license.png
---
...
The tradeoff is real, though. MIT doesn't prevent large companies from taking Tour Kit's code and building a competing product. AGPL would. We decided wider adoption mattered more than protection from theoretical competition. (For more on that decision, see [why we chose MIT over AGPL and BSL](https://usertourkit.com/blog/why-we-open-sourced-tour-kit-mit-not-agpl-bsl).)
