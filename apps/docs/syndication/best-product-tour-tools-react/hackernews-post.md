...
Bundle sizes are all over the place. Driver.js is 5KB. React Joyride is 30KB (6x larger). The SaaS platforms inject 80-90KB at runtime. The headless libraries (userTourKit, OnboardJS) sit around 8-10KB.
...
Full disclosure: I built one of the tools on this list (userTourKit). I've tried to keep the evaluation honest — every number comes from npm, GitHub, or bundlephobia. If you disagree with any of the rankings, I'd genuinely like to hear why.
