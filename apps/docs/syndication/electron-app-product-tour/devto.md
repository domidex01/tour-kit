---
title: "Building product tours for Electron desktop apps with React"
published: false
description: "Electron adds complexity that web-only tour libraries ignore: main/renderer process splits, native menus outside the DOM, and multi-window layouts. Here's how to build a proper product tour that handles all of it."
tags: react, javascript, electron, tutorial
canonical_url: https://usertourkit.com/blog/electron-app-product-tour
cover_image: https://usertourkit.com/og-images/electron-app-product-tour.png
---
...
- Adding [conditional tours based on user role](https://usertourkit.com/blog/conditional-product-tour-user-role) for power users versus first-timers
- Building a [progress persistence layer](https://usertourkit.com/blog/tour-progress-persistence-localstorage) that syncs across devices when online
- Using [hotspot components](https://usertourkit.com/blog/react-hotspot-component) for ongoing feature discovery after the initial tour
