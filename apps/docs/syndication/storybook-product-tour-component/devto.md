---
title: "How to document and test product tour components in Storybook"
published: false
description: "Set up Tour Kit components in Storybook 8 with Autodocs, play functions for multi-step flows, and the a11y addon. Full TypeScript examples."
tags: react, typescript, webdev, tutorial
canonical_url: https://usertourkit.com/blog/storybook-product-tour-component
cover_image: https://usertourkit.com/og-images/storybook-product-tour-component.png
---
...
<!-- Embed Canvas and Controls for TourTooltipStories.SingleStep -->

## Headless variant

Uses useTour() hook for full rendering control. You write the JSX.

<!-- Embed Canvas for HeadlessStories.CustomTooltip -->
```
...
They test different things. The a11y addon catches WCAG violations like missing roles and color contrast failures. Chromatic catches visual regressions like tooltip misalignment and overlay shifts by comparing screenshots. Use both for complete storybook product tour component coverage.
