---
title: "Customer lifetime value: why churn sits in the denominator and onboarding controls it"
published: false
description: "CLV = (ARPU x Margin) / Churn Rate. That denominator means halving churn doubles lifetime value. Here's the formula, worked examples, and data on why onboarding is the biggest lever."
tags: saas, webdev, productivity, beginners
canonical_url: https://usertourkit.com/blog/what-is-customer-lifetime-value
cover_image: https://usertourkit.com/og-images/what-is-customer-lifetime-value.png
---

*Originally published at [usertourkit.com](https://usertourkit.com/blog/what-is-customer-lifetime-value)*
...
| Scenario | Monthly churn | CLV (at $20K ARPA, 80% margin) | Change |
|---|---|---|---|
| Baseline | 5% | $320,000 | — |
| Better onboarding | 2.5% | $640,000 | +100% |
| Great onboarding + expansion | 1.5% | $1,066,667 | +233% |
...
Engineering choices affect these outcomes directly. Bundle size determines whether tours load on slower connections. Accessibility decides whether all users can finish them. And personalization capability controls whether users see role-relevant tours or generic walkthroughs nobody reads. [Tour Kit's](https://usertourkit.com/) headless architecture gives teams control over all three, though it requires React developers rather than a point-and-click builder and has a smaller community than established tools like React Joyride (603K weekly npm downloads).
