---
title: "Connect your product tour to onboarding emails with React Email + Resend"
published: false
description: "Most product tours end at the browser tab. Here's how to wire Tour Kit's analytics callbacks to React Email so your onboarding continues in the inbox — with behavior-based email triggers, not fixed drip schedules."
tags: react, typescript, webdev, tutorial
canonical_url: https://usertourkit.com/blog/tour-kit-react-email-onboarding-emails
cover_image: https://usertourkit.com/og-images/tour-kit-react-email-onboarding-emails.png
---
...
No. React Email templates render server-side to static HTML strings via the `render()` function. None of the email component code ships to the browser. The 6.5 MB `@react-email/tailwind` dependency lives in your server bundle only. Your client-side bundle stays exactly the same size, which matters for Tour Kit's <8KB core footprint.
