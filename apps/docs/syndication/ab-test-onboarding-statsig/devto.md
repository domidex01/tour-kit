---
title: "A/B test your onboarding tours with Statsig + Tour Kit (free, under 22KB)"
published: false
description: "Set up experiment-driven onboarding with Statsig's free tier and a headless React tour library. Variant switching, activation tracking, and guardrail metrics included."
tags: react, javascript, webdev, tutorial
canonical_url: https://usertourkit.com/blog/ab-test-onboarding-statsig
cover_image: https://usertourkit.com/og-images/ab-test-onboarding-statsig.png
---
...
- **Read our general A/B testing guide** for methodology on sample sizes, test duration, and metric selection: [How to A/B test product tours](https://usertourkit.com/blog/ab-test-product-tour).
