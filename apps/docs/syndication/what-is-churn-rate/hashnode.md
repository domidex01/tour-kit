...
canonical: https://usertourkit.com/blog/what-is-churn-rate
tags: saas, react, web-development, javascript
---
...
Two steps. One goal: get the user to their first project.
...
The tradeoff: there's no visual builder. You write the tour in code, which means a developer needs to be involved.

## FAQ

### What is a good churn rate for SaaS?

Below 3% monthly for established B2B SaaS. Annual churn below 5% puts you in the top tier. Early-stage companies run higher at 5-7% monthly.

### How do you calculate monthly churn rate?

Divide customers lost during the month by customers at the start, then multiply by 100. Started with 900 and lost 30? That's 3.33%.
...
Customer churn counts the percentage of accounts lost, treating every customer equally. Revenue churn (MRR churn) measures the percentage of recurring revenue lost from cancellations and downgrades.
