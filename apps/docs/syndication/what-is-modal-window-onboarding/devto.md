...
published: false
description: "Modal windows block interaction with the page behind them. Here's when that's useful in onboarding, how the native HTML dialog element works, and what 70% of custom implementations get wrong on accessibility."
tags: react, javascript, webdev, accessibility
canonical_url: https://usertourkit.com/blog/what-is-modal-window-onboarding
cover_image: https://usertourkit.com/og-images/what-is-modal-window-onboarding.png
---
