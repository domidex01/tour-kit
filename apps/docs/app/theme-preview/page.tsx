export default function ThemePreview() {
  return (
    <div className='min-h-screen bg-tk-surface p-8 space-y-12'>
      <header>
        <h1 className='text-4xl font-bold text-tk-on-surface'>
          TourKit Theme Preview
        </h1>
        <p className='text-tk-on-surface-variant mt-2'>
      ...
      {/* Brand Colors */}
      <section>
        <h2 className='text-xl font-semibold mb-4 text-tk-on-surface'>
          Brand Colors
        </h2>
        <div className='flex flex-wrap gap-4'>
          <div className='flex flex-col items-center'>
            ...
            <span className='mt-2 text-xs text-tk-on-surface-variant'>
              #0056ff
            </span>
          </div>
          <div className='flex flex-col items-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
          ...
          <div className='bg-tk-primary-container rounded-xl p-6'>
            ...
            <p className='text-sm mt-2'>
              This card uses the primary container color.
            </p>
            <button className='btn-primary mt-4'>Action</button>
          </div>
