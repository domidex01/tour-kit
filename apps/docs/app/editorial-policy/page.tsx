      ...
      >
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            ...
            entries) is drafted with the help of large language models, currently Anthropic's Claude
            family, and then reviewed, edited, fact-checked, and code-tested by a human before
            publication. No AI-generated content ships unreviewed. Technical claims generated by AI
            are verified against primary sources (official docs, source code, npm) before merge.
          </p>
