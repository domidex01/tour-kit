      ...
      >
        ...
        <article className="prose prose-neutral dark:prose-invert max-w-none">
          ...
          <p>
            ...
            measurement would require us to re-run a benchmark, we publish the methodology, not just
            the number, so it can be reproduced. If a claim cannot be verified, it is not published.
          </p>
