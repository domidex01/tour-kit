...
function DemoContent() {
  ...
  const steps = [
    { target: 'demo-title', title: 'Welcome to TourKit!', content: "This is an interactive demo. Click 'Next' to continue." },
    { target: 'demo-feature-1', title: 'Feature Highlights', content: 'Tours can highlight any element on the page.' },
    { target: 'demo-feature-2', title: 'Step by Step', content: 'Guide users through your application flow.' },
    { target: 'demo-feature-3', title: 'Fully Customizable', content: 'Style everything to match your brand.' },
    { target: 'demo-start', title: "That's it!", content: 'Try TourKit in your own project today.' },
  ];
  ...
  return (
    <div className='relative rounded-xl border border-fd-border bg-fd-card p-8'>
      ...
      <div className='mb-8 flex items-center justify-between'>
        <h3 id='demo-title' className={`text-xl font-semibold ${currentStep?.target === 'demo-title' ? 'ring-2 ring-[var(--tk-primary)] ring-offset-2 rounded-lg p-2 -m-2' : ''}`}>
          Interactive Demo
        </h3>
