...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'The positioner uses a MutationObserver and re-queries on route changes, so tours survive async mounts, route transitions, and conditional rendering. If a target disappears mid-tour, you pick: skip the step, pause until it returns, or fall back to a centered dialog. All three are one-line configs.',
  },
  {
