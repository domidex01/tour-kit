...
export const teamMembers: TeamMember[] = [
  { id: 'u-1', name: 'Priya Kapoor', email: 'priya@stacks.app', role: 'admin', avatar: 'PK', department: 'Design' },
  { id: 'u-2', name: 'Jordan Reyes', email: 'jordan@stacks.app', role: 'admin', avatar: 'JR', department: 'Engineering' },
  { id: 'u-3', name: 'Sam Lin', email: 'sam@stacks.app', role: 'editor', avatar: 'SL', department: 'Data' },
  { id: 'u-4', name: 'Mia Okafor', email: 'mia@stacks.app', role: 'editor', avatar: 'MO', department: 'Mobile' },
  { id: 'u-5', name: 'Henry Choi', email: 'henry@stacks.app', role: 'viewer', avatar: 'HC', department: 'Operations' },
  { id: 'u-6', name: 'Ada Fields', email: 'ada@stacks.app', role: 'editor', avatar: 'AF', department: 'Engineering' },
  { id: 'u-7', name: 'Luca Rossi', email: 'luca@stacks.app', role: 'viewer', avatar: 'LR', department: 'Marketing' },
  { id: 'u-8', name: 'Nia Patel', email: 'nia@stacks.app', role: 'editor', avatar: 'NP', department: 'Design' },
]
...
export const faqEntries = [
  { q: 'How do I invite a teammate?', a: 'Open the Team page and click "Invite". Share the link with your teammate — they sign up with their work email.' },
  { q: 'Can I export my kanban board?', a: 'Yes. Open any project and click Export to download a CSV snapshot of every card.' },
  { q: 'Where do I change my notification preferences?', a: 'Settings → Notifications. You can pick email, Slack, or in-app for each event type.' },
  { q: 'How does billing work?', a: 'Monthly or annual billing via Polar. Upgrade under Settings → Billing.' },
  { q: 'What keyboard shortcuts exist?', a: 'Press ⌘K anywhere to open the command palette and see the full list.' },
]
