...
const productDocs = [
  {
    id: 'getting-started',
    content: 'To get started with Tour Kit, install the package and wrap your app in a TourKitProvider.',
...
const { POST } = createChatRouteHandler({
  model: {} as any, // Replace with: openai('gpt-4o-mini') after installing @ai-sdk/openai
  context: {
