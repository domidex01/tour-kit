...
purpose without charge. Production use requires a valid Tour Kit Pro licence
key. "Production use" means serving the Licensed Work to end users of a
...
or to purchase a licence key, see https://usertourkit.com/pricing or contact
...
1. To specify as the Change License the GPL Version 2.0 or later, or a license
   that is compatible with GPL Version 2.0 or later, where "compatible" means
   that software provided under the Change License can be included in a program
   with software provided under GPL Version 2.0 or later. Licensor may specify
