...
- 3f929b1: Complete the `AiChatConfig.strings` honesty pass from 0.13.0 — every advertised
...
- f44a4dd: Make every advertised AI knob either consumed or gone, and reframe the package's
