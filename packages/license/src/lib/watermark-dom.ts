 ...
 *
 * `typeof process` is checked before the read: this module is reachable from
 * `@tour-kit/license/headless`, which a browser can load unbundled, and an
 * unguarded `process.env` throws `ReferenceError` there.
 */
