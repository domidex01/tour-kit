...
describe('QuestionRating preset="stars"', () => {
  it('renders exactly 5 buttons (1..5)', () => {
    render(<QuestionRating preset="stars" onChange={() => {}} />)
  ...
  it('clicking the third star fires onChange(3)', async () => {
    ...
    render(<QuestionRating preset="stars" onChange={onChange} />)
    const buttons = screen.getAllByRole('radio')
  ...
  it('explicit `ratingScale` overrides the preset', () => {
    render(<QuestionRating preset="stars" ratingScale={{ min: 0, max: 10 }} onChange={() => {}} />)
    const buttons = screen.getAllByRole('radio')
