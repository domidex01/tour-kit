---
title: Launch Copy Kit
type: gtm
sources:
  - ../../marketing-strategy/launch-copy-kit.md
updated: 2026-04-19
---
...
**Link:** GitHub repo (NOT docs site or landing page).
...
**Title:** `How to add accessible product tours to Next.js App Router (open source, works with shadcn/ui)`
...
**Title:** `How I'm replacing $300/month onboarding tools with a $99 one-time open-source library`
...
**Title:** `Introducing Tour-Kit: Headless Product Tours for React (Open Source)`
...
### shadcn/ui
> tour-kit is designed to work natively with @shadcn's component patterns. Same Radix primitives, same composition philosophy. Building on top of shadcn/ui is one of the best decisions we made.

### Radix UI
> The accessibility patterns in tour-kit are informed by @radix_ui. Focus management, keyboard handling, and ARIA patterns done right. Grateful for the prior art.
...
**Subject:** `New open-source headless tour library for React — launching [date]`
...
- [gtm/launch-checklist.md](launch-checklist.md)
- [gtm/launch-strategy.md](launch-strategy.md)
- [gtm/content-templates.md](content-templates.md) — Templates for ongoing content
- [brand/voice.md](../brand/voice.md) — Rules the copy follows
